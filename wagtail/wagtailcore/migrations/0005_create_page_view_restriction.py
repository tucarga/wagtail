...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wagtailcore_pageviewrestriction', (
        ...
        db.send_create_signal(u'wagtailcore', ['PageViewRestriction'])


    def backwards(self, orm):
        # Deleting model 'PageViewRestriction'
        db.delete_table(u'wagtailcore_pageviewrestriction')
